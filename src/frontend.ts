...
function bankLogoUrl(domain) { return 'https://www.google.com/s2/favicons?domain=' + domain + '&sz=128'; }
...
function categoryBadgeHtml(leadType) {
  ...
  const logoImg = domain
    ? '<img src="https://www.google.com/s2/favicons?domain=' + domain + '&sz=128" alt="" data-domain="' + domain + '" style="width:15px;height:15px;border-radius:4px;object-fit:contain;flex-shrink:0;" onerror="bankImgChain(this)" />'
    : '';
